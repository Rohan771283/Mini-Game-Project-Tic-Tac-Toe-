...
// Function to draw the current game board layout dynamically using explicit array indexing
...
void playGame() {
    // Initialize standard board with tracking numbers 1 to 9
    vector<char> board = {'1', '2', '3', '4', '5', '6', '7', '8', '9'#include <iostream>
#include <vector>
